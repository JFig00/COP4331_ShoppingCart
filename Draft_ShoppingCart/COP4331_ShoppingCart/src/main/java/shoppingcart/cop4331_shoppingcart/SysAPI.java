...
//        double rand_1 = rand.nextDouble(15);
...
//                    listSell.get(i).SetRevenue(listSell.get(i).GetRevenue() + rand_1);
//                }
                    ...
                    for (int j = 0; j < listSell.size(); j++){
                        ...
                        for (int n = 0; n < listSell.get(j).ProdList().size(); n++){
                            if (currentCust.ProdList().getItem(i).Getname().equals(listSell.get(j).ProdList().getItem(n).Getname())){
                                double TotalRev = listSell.get(j).GetRevenue() + currentCust.ProdList().getItem(i).GetPrice();
                                listSell.get(j).SetRevenue(TotalRev); 
                                double TotalProfit = listSell.get(j).GetRevenue() - currentCust.ProdList().getItem(i).GetCost();
                                listSell.get(j).SetProfit(TotalProfit);
                            }
                        }
                    }
                }
